...
def solve_grot(board_matrix):
    ...
    def count_path_len(row_num, col_num):
        ...
        board_matrix_copy = copy.deepcopy(board_matrix)  # We need it so we can remove visited items from the board
    ...
    for row_num, row in enumerate(board_matrix):  # For every row ...
